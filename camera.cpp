...
//         Position = maths::add(Position, maths::mul(Front,velocity));
//     if (direction == BACKWARD)
//         Position = maths::sub(Position, maths::mul(Front,velocity));
//     if (direction == LEFT)
...
//     Right = maths::normalize(maths::cross(Front, WorldUp));  // normalize the vectors, because their length gets closer to 0 the more you look up or down which results in slower movement.
